    ...
    <footer className="bg-slate-900 dark:bg-slate-950 text-white" data-testid="footer">
      <div className="container mx-auto px-4">
        ...
        <div style={{ display: "flex", justifyContent: "center", padding: "16px 0" }}>
          <a
            className="tvd-badge tvd-badge--dark"
            href="https://digital.todovendingca.com"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="tvd-badge__icon-wrap">
              <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/>
                <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/>
              </svg>
            </span>
            <span className="tvd-badge__text">Página web creada por <span className="tvd-badge__brand">Digital.TodoVendingca.com</span></span>
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, color: "#475569" }}>
